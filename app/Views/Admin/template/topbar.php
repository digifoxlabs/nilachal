...
-->
      <div class="container-fluid" style="display:flex;align-items: center;justify-content:space-between;">
         <a href="offline_booking.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-database fa-sm text-white-50"></i> Offline Booking</a> 
