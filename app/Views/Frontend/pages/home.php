 ...
 <section class="section swiper-container swiper-slider swiper-slider-corporate swiper-pagination-style-2" data-loop="true" data-autoplay="5000" data-simulate-touch="true" data-nav="false" data-direction="vertical">
        <div class="swiper-wrapper text-left">
          <div class="swiper-slide context-dark" data-slide-bg="<?= base_url("assets/frontend/img/slider_1.jpg") ?>">
          ...
          <div class="swiper-slide context-dark" data-slide-bg="<?= base_url("assets/frontend/img/slider_2.jpg") ?>">
            <div class="swiper-slide-caption section-md">
              <div class="container">
                <div class="row">
                  <div class="col-md-10">
                    <h6 style="color: black;background: #ffff;display: inline;"class="text-uppercase" data-caption-animate="fadeInRight" data-caption-delay="0">Enjoy the Best Staying Experince with Nilachal Hotel</h6>
                    <h2 style="color: white" class="oh font-weight-light" data-caption-animate="slideInUp" data-caption-delay="100">
                    <span class="font-weight-bold">Trust Our Experience</span>
                    </h2><a class="button button-primary button-ujarak" href="#" data-caption-animate="fadeInLeft" data-caption-delay="0">Get in touch</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row row-50 align-items-center justify-content-center justify-content-xl-between">
            ...
            <div class="col-lg-6 wow fadeInRight" data-wow-delay=".1s">
              <div class="box-width-lg-470">
                <h3>Discover New Horizons With Nilachal Hotels</h3>
                <!-- Bootstrap tabs-->
